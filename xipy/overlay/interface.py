"""
This module defines two interface classes:

* OverlayWindowInterface -- a Qt4 level interface window class
* OverlayInterface -- a Traits level data manager/monitor class

And additionally a functional base class

* ThresholdMap -- a Traits-enabled scalar thresholding tool
