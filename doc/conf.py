...
print 'importing local extensions'
...
copyright = '2009-2010, UCSF Biomagnetic Imaging Laboratory' 
...
latex_documents = [
  ('contents', 'xipy.tex', 'Cross-Modality Imaging in Python Documentation',
   ur'UCSF Biomagnetic Imaging Laboratory.','manual'),
]
