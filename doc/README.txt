==============================
XIPY Documentation System
==============================

This documentation system is created using reST_, a markup language
format, and Sphinx_, a docs generation utility written in Python_. The 
structure of these docs is largely copied from the example of the
NIPY_ project, which in turn adapted documentation code from Matplotlib_, 
pyMVPA_, and others.

In order to build the documentation, you must have Sphinx v0.5 or greater installed.
...
* _py_api_tools - Python code used for automatic API docs generation
